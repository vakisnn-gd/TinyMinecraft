...
TinyCraft - маленькая Java/LWJGL voxel-песочница в стиле Minecraft. В игре есть блочный мир, биомы, пещеры, шахты, деревни, мобы, инвентарь, крафт, сундуки, печки, жидкости и команды для исследования мира.
...
1. Откройте [страницу релизов](https://github.com/vakisnn-gd/TinyCraft/releases).
2. Скачайте `TinyCraft-v0.2-windows.zip`.
3. Распакуйте архив.
...
- [Wiki](https://github.com/vakisnn-gd/TinyCraft/wiki) - русская wiki-страница проекта.
...
Для обычной игры скачивайте `TinyCraft-v0.2-windows.zip`.
